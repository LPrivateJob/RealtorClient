 ...
 * </pre>
 */
public class StagingLeaseApplication extends TinkerApplication {
    public StagingLeaseApplication() {
        super(ShareConstants.TINKER_ENABLE_ALL, "com.realtor.jx.hotfix.StagingLeaseApplicationLike",
