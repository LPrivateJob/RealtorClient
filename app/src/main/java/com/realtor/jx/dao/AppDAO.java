...
public class AppDAO extends BaseDAO {
    ...
    //查询订单列表
    public void queryOrderList(String keyWords,String orderStatus,String orderType,String pageNum,String pageSize,JsonUiCallback<UserInfoDto> callback){
    ...
    //查询订单详情
    public void queryOrderDetail(String orderId,JsonUiCallback<UserInfoDto> callback){
