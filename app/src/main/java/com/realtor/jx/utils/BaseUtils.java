...
import com.realtor.jx.netcore.utils.AES;
...
//    }
//
//    private static void saveUserProfile(File f, Object saveObject) {
...
//    }
    ...
    public static Object restoreObject(Context context, String filename) {
        ...
        try {
            ...
            byte[] sourceByte = (byte[]) ois.readObject();
     ...
     * 加密对象
     */
    public static void EncryptObject(Context context, String filename, Object object) {
        try {
            FileOutputStream fos = context.openFileOutput(filename, Context.MODE_PRIVATE);
            ObjectOutputStream oos = new ObjectOutputStream(fos);
     ...
     * 解密对象
     */
    public static Object DecipherObject(Context context, String filename) {
        Object o = null;
        try {
            FileInputStream fis = context.openFileInput(filename);
            ObjectInputStream ois = new ObjectInputStream(fis);
